...
/**
  ...
  *
  * @checksum - 7fc61fb022eff0385795a80ab8d94b0e9e27a4c7e260613251e598346bb0da7c
  * @variables - radius=rounded-lg,accentColor=violet,colorTemperature=neutral,spacing=2.5,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
